...
export default async function Home() {
  return (
    <div className="pt-2">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          <div className="bg-white rounded-lg shadow-lg p-6">
            ...
            <p className="text-gray-600 mb-4">
              ...
              interactions of a website or web application. It focuses on using
              technologies like React to build responsive and interactive user
              interfaces.
            </p>
      ...
      <section id="community" className="mx-auto max-w-screen-xl py-4 lg:py-20">
        <h2 className="text-3xl font-bold text-center mb-8">
          Join the Community
        </h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 justify-center text-center">
            ...
            <p className="text-gray-600 mb-4">
              Level Up Dev is a community of web developers and enthusiasts, who
              are passionate about learning and growing together. Join us to
